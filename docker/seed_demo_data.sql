-- ====================================================================
-- REALISTIC DEMO SEED DATA FOR RETAIL SUPERMARKET & POS SYSTEM
-- Complete realistic dataset: Suppliers, Customers, Categories, 
-- Products (Barcodes, SKUs, PLUs), Batches, Expiry, Purchases, Sales, Expenses
-- ====================================================================
